...
})(Heuristic = exports.Heuristic || (exports.Heuristic = {}));
var PathFinding = (function () {
    ...
    PathFinding.prototype.isTileWalkable = function (mapItem) {
        return this.walkableTypes.some(function (type) { return type.type == mapItem; });
    };
    PathFinding.prototype.getTileWalkable = function (mapItem) {
        return this.walkableTypes.filter(function (type) { return type.type == mapItem; })[0];
    };
    PathFinding.prototype.find = function (map) {
        ...
        var firstElement = (typeof this.start !== "number") ? new Node_1.Node(this.start.row, this.start.col, 0) : this.findStartElement(finalMap);
    ...
    PathFinding.prototype.updateLists = function (map, currentNode, closedList, openList, lastElement) {
        var _this = this;
        var validAdjacents = this.findAdjacents(map, currentNode).filter(function (elementAdjacent) { return _this.elementNotExistsInside(closedList, elementAdjacent); });
        var validAdjacentsOpenList = validAdjacents.filter(function (elementAdjacent) { return _this.elementExistsInside(openList, elementAdjacent); });
        ...
        var validAdjacentsNewOpenList = validAdjacents.filter(function (elementAdjacent) { return _this.elementNotExistsInside(openList, elementAdjacent); });
